    ...
    return (
        <div className='pt-10 py-8'>
            ...
            <div className="flex flex-col items-center mt-4">
                <div className="cursor-pointer flex items-center justify-between w-full max-w-2xl sm:max-w-3xl min-h-[80px] px-4 sm:px-6">
                        ...
                        <div className="flex items-center justify-between flex-1 min-w-0">
                            <div className="flex items-center gap-4 min-w-0">
                                <div className="min-w-0">
                                    <h2 className={`${bricolage_grotesque} text-lg sm:text-xl font-semibold sm:whitespace-nowrap truncate`}>
