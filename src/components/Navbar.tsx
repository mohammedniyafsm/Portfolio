          ...
          {navItems.map((item) => (
            ...
            >
              <h1
                ...
                className={`font-sans font-light text-sm cursor-pointer ${item.onClick ? "" : "cursor-default"
                  }`}
              >
                {item.label}
              </h1>
              ...
              {navItems.map((item) => (
                ...
                >
                  <h1
                    ...
                    className={`font-sans font-light text-base ${item.onClick ? "cursor-pointer hover:text-primary transition-colors" : ""
                      }`}
                  >
                    {item.label}
                  </h1>
