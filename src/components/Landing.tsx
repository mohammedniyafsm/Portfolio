...
export default function Landing() {
    ...
    return (
        <div className="relative top-0 md:top-0 flex min-h-screen w-full overflow-hidden rounded-md bg-black/[0.96] antialiased items-center justify-center">
            {/* Spotlight - Responsive positioning */}
            <div className="absolute inset-0 w-full h-full pointer-events-none z-0">
                <Beams
                    beamWidth={isMobile ? 1 : 2}
                    beamHeight={isMobile ? 40 : 50}
                    beamNumber={12}
                    lightColor="#ffffff"
                    speed={2}
                    noiseIntensity={1.75}
            ...
            <div id="name" className="relative z-10 mx-auto w-full max-w-7xl p-4 pt-6 md:pt-20 lg:pt-0">
                ...
                <div className="mt-8 flex justify-center sm:px-0 gap-4  items-center  sm:flex-row  sm:gap-6 md:mt-12 md:gap-6">
                    ...
                    <Button
                        ...
                        className="w-28 max-w-[200px] cursor-pointer px-6 py-4 text-sm sm:w-auto sm:max-w-none sm:px-8 sm:py-4 sm:text-base md:px-10"
                    >
                        Get in Touch
                    </Button>
                </div>
